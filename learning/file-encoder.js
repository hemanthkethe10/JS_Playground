module.exports = (input)=>{
  ...
  let errorMap = [];
  let excludedKeys =[];
  input.currentRoutes.map((_,rIndex)=>{
    let routeKey1 = `currentRoutes.${rIndex}.destinations.businessTag`;
    let routeKey2 = `currentRoutes.${rIndex}.destinations.businessTag`;
    ...
    route.destinations.map((_,dIndex)=>{
        ...
        excludedKeys.push(destinationKey)
    })
  })
